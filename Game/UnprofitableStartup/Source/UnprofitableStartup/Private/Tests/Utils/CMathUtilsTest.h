 ...
 */
class CMathUtilsTest : public FAutomationTestBase
{
public:
    // Constructor to initialise the FAutomationTestBase
    CMathUtilsTest(const FString& aInName, const bool abInComplexTask) : FAutomationTestBase(aInName, abInComplexTask) {}
};